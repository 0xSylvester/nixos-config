...
spawn-sh-at-startup "wayscriber -d"
...
binds {
    ...
    Mod+D hotkey-overlay-title="Run Application Launcher " { spawn-sh "noctalia-shell ipc call launcher toggle "; }
    //Mod+Shift+D hotkey-overlay-title="Run an Application: wofi" { spawn-sh "wofi --show drun";}
    Super+X hotkey-overlay-title="Lock the Screen" { spawn-sh "noctalia-shell ipc call lockScreen lock "; }
    ...
    Mod+Shift+Home hotkey-overlay-title="Session Menu" {spawn-sh "noctalia-shell ipc call sessionMenu toggle"; }
